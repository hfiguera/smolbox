...
SmolBox 0.2.1 defaults to smolvm 1.19.0; 0.2.0 defaults to 1.17.0 on Linux x86_64 or macOS Apple Silicon.
Versions 0.1.4–0.1.5 default to 1.16.1.
Version 0.1.3 defaults to 1.16.0 and 0.1.2 to 1.14.6.
