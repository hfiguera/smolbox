...
You need a **dedicated, empty worker**: select **smolvm 1.19.0 on Linux x86_64 or
macOS Apple Silicon**. Existing 1.17.0 and other supported deployments require an explicit
