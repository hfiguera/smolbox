...
|---|---|
| Dependency cannot be fetched | Use `{:smolbox, "~> 0.1.1"}` and check connectivity to Hex. For an optional Git dependency, verify the public repository URL and requested tag. |
